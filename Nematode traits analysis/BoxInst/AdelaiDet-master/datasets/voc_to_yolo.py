"""
将voc数据集标注信息(.xml)转为yolo标注格式(.txt)，并将图像文件复制到相应文件夹
"""
import os
...
# voc数据集根目录以及版本
voc_root = "D:/shanghai_grain/grain_datasets"
voc_version = "grain"
...
# 转换后的文件保存目录
save_file_root = "D:/shanghai_grain/grain_datasets_yolo"

# label标签对应json文件
label_json_path = 'D:/shanghai_grain/grain_datasets/trainval.json'
